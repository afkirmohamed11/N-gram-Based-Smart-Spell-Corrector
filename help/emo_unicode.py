...
UNICODE_EMOJI = {v for v in EMOTICONS_EMO.items()}

UNICODE_EMOJI_ALIAS = {v: k for k, v in EMOJI_ALIAS_UNICODE.items()}
# print(UNICODE_EMOJI)
# for i in UNICODE_EMOJI:
    # print(i[0])
    # print(i[1])
# if __name__ == "__main__":
#     for index, (key, value) in enumerate(UNICODE_EMOJI.items()):
#         print(f'Item {index + 1}: Key: {key}, Value: {value[1:-1]}')
#         if index == 10:
#             break
